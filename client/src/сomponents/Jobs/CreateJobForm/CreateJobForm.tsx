...
import { JobsApi, Job, JobCreateData, JobType, JOB_CATEGORIES, JOB_TYPE_LABELS } from '../../../api/JobsApi';
...
const CreateJobForm: React.FC<CreateJobFormProps> = ({ companyId, onSubmit, onCancel }) => {
